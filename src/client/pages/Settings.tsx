      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-6">
            <Mail className="text-fuchsia-600 mr-3" size={24} />
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-6">
            <Smartphone className="text-fuchsia-600 mr-3" size={24} />
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-6">
            <Bell className="text-fuchsia-600 mr-3" size={24} />
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-6">
            <Globe className="text-fuchsia-600 mr-3" size={24} />
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-6">
            <Shield className="text-fuchsia-600 mr-3" size={24} />
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-6">
            <Lock className="text-fuchsia-600 mr-3" size={24} />
          ...
          <div className="space-y-6">
            <div className="border-b border-gray-100 pb-6">
              ...
              <div className="space-y-4">
                ...
                <button className="bg-fuchsia-600 text-white px-6 py-2 rounded-lg hover:bg-fuchsia-700">
                  Mettre à jour
                </button>
              </div>
            </div>
        ...
        <div className="flex justify-end">
          <button className="bg-fuchsia-600 text-white px-8 py-3 rounded-lg hover:bg-fuchsia-700 flex items-center">
